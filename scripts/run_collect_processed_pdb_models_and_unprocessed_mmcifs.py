...
if __name__ == '__main__':
    ...
    if not os.path.exists(f'{abs_path}/../database/unprocessed_mmcifs_{dts}'):
        os.system(f'mkdir {abs_path}/../database/unprocessed_mmcifs_{dts}')
    ...
    for ent in ents:
        l2code = ent[1:3]
        os.system(f'cp {abs_path}/../database/mmCIF_divided/{l2code}/{ent}.cif.gz {abs_path}/../database/unprocessed_mmcifs_{dts}')
    os.system(f'gunzip -r {abs_path}/../database/unprocessed_mmcifs_{dts}')
    os.system(f'tar -czf {abs_path}/../database/unprocessed_mmcifs_{dts}.tar.gz {abs_path}/../database/unprocessed_mmcifs_{dts}')
