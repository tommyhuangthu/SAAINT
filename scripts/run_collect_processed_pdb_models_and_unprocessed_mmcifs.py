...
if __name__ == '__main__':
    ...
    os.system(f'cp {abs_path}/../database/saaint_divided/*.pdb {abs_path}/../database/models/processed_pdb_models_{dts}/')
    ...
    os.remove(f'{abs_path}/../list_saaintdb_pdbs_{dts}.txt')
    for ent in ents:
        l2code = ent[1:3]
