...
def get_ab_ag_pair_chain_ids(pdbid):
    l2code = pdbid[1:3]
...
def merge_affinity_data_and_chain_ids(old_affinity_file, saaint_file, affinity_file):
    ...
    for i, list1 in enumerate(lists1):
        ...
        model_HL_dict = get_ab_ag_pair_chain_ids(pdbid)
...
if __name__ == '__main__':
    ...
    merge_affinity_data_and_chain_ids(old_aff_file, saaint_file, new_aff_file)
